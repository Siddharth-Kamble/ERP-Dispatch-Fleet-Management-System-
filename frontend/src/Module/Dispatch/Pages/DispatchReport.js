...
//  useEffect(() => {
//    axios.get("http://localhost:8080/projects") // Adjust URL to your project list endpoint
...
//    try {
//      setLoading(true);
//      await axios.post(`http://localhost:8080/project-records/${selectedProject}`, formData);
...
//          <form onSubmit={handleAddRecord} style={styles.gridForm}>
//            <select
//              style={styles.input}
...
//            <textarea name="remark" placeholder="Remarks" style={{...styles.input, gridColumn: "span 2"}} value={formData.remark} onChange={handleInputChange} />
//
