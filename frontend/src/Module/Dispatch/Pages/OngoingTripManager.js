...
// export default OngoingTripManager;
    ...
    //             console.log("GPS already running for", tripId);
    //             return;
    //         }
    //
    ...
    //                 } catch (err) {
    //                     console.error("❌ GPS Update failed:", err.response?.data || err.message);
    //                 }
    //
    //             },
    //
    ...
    //         );
    //
    //         intervalRefs.current[tripId] = watchId;
    //         console.log("🚀 GPS Started for trip", tripId);
    //     };
    //
    //     const stopGPSTracking = (tripId) => {
    //
    //         if (intervalRefs.current[tripId]) {
    //
    //             navigator.geolocation.clearWatch(intervalRefs.current[tripId]);
    ...
    //     useEffect(() => {
    //         return () => {
    //             Object.keys(intervalRefs.current).forEach((tripId) => {
    //                 navigator.geolocation.clearWatch(intervalRefs.current[tripId]);
    //             });
    //         };
    //     }, []);
    ...
    //             if (
    //                 ["IN_TRANSIT", "RETURN_JOURNEY_STARTED"].includes(trip.status)
    //             ) {
    ...
    //             );
    //             // Start GPS tracking only for in-motion statuses
    //             if (["IN_TRANSIT", "RETURN_JOURNEY_STARTED"].includes(nextStatus)) {
    //                 startGPSTracking(trip.id);
    //             }
    //
    //
    //             // Stop GPS tracking when trip completes
    //             if (["UNLOADING_COMPLETED", "RETURN_JOURNEY_COMPLETED"].includes(nextStatus)) {
    //                 stopGPSTracking(trip.id);
    //             }
    //         } catch (err) {
    //             alert("Status update failed");
    ...
    //             display: "flex",
    //             flexDirection: "row",
    //             flexWrap: "wrap", // Crucial for responsiveness
    //             gap: "24px",
    //             alignItems: "center"
    //         },
    //         section: {
    //             flex: "1 1 200px", // Allows sections to grow and wrap
    //             minWidth: "150px"
    //         },
    //         label: {
    //             fontSize: "11px",
    ...
    //                         const isLoading = loadingIds.includes(trip.id);
    //
    //                         return (
    ...
    //                                     <p style={{ margin: 0, color: "#475569", fontWeight: "500" }}>{trip.driverName}</p>
    //                                 </div>
    //
    //                                 {/* Status & Progress */}
    ...
    //                                         {trip.points?.length > 0 ? trip.points.join(" → ") : "Direct Route"}
    //                                     </p>
    //                                 </div>
    //
    //                                 {/* Action Button */}
...
//         }
//
//         // ✅ Check if already tracking this specific trip to avoid duplicates
