...
function PowderCoatingDashboard() {

    const [activePage, setActivePage] = useState("dashboard");

    const user = JSON.parse(localStorage.getItem("user"));
    const departmentName = user?.role || "POWDER_COATING";
    ...
    return (
        <div style={styles.container}>
            ...
            <aside style={styles.sidebar}>
                ...
                <h2 style={styles.logo}>POWDER COATING </h2>
            ...
            <div style={styles.mainWrapper}>
                ...
                <footer style={styles.footer}>
                    ...
                    <span>Powder Coating Module • Version 1.0</span>
                </footer>
...
export default PowderCoatingDashboard;
